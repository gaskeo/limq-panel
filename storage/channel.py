...
from storage.keygen import CHANNEL_ID_LENGTH
...
class Channel(ModelBase):
    ...
    forwards = sqlalchemy.Column(sqlalchemy.String(length=512),
                                 nullable=True,
                                 unique=False)
    ...
    def mixins(self) -> Iterable:
        ...
        return (self.forwards[i:i + CHANNEL_ID_LENGTH]
                for i in range(0, ll, CHANNEL_ID_LENGTH))
